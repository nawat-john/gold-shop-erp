...
import { approveStockCountAction } from "../actions";

export function ApproveStockForm({ countId }: { countId: string }) {
    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      ...
      >
        <h3 className="font-bold text-base border-b border-gray-100 pb-2">
          อนุมัติปรับปรุงสต๊อกสินค้า (Step-up Auth)
        </h3>
        ...
        <p className="text-[10px] text-gray-500 italic">
          * ระบบกำหนดให้ผู้อนุมัติต้องไม่ใช่คนเดียวกันกับผู้เปิดกะ/ผู้นับ
          (Maker-Checker)
        </p>
        ...
        <div className="flex justify-end gap-2 mt-2 pt-2 border-t border-gray-100">
          ...
          >
            {isPending ? "กำลังตรวจสอบ..." : "ยืนยันอนุมัติ"}
          </button>
        </div>
      </form>
    </div>
